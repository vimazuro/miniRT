...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/07/28 14:25:21 by vimazuro          #+#    #+#             */
/*   Updated: 2025/07/29 16:14:25 by vimazuro         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_cylinder_coeffs(t_ray ray, t_cylinder cylinder, t_quadratic *q)
{
	...
	d_perp = vec3_sub(ray.direction, vec3_scale(cylinder.orientation,
				vec3_dot(ray.direction, cylinder.orientation)));
	oc_perp = vec3_sub(oc, vec3_scale(cylinder.orientation,
